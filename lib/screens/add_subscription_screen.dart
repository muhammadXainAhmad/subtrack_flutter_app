                      ...
                      child: Column(
                        ...
                        children: [
                          AddSubscriptionDropdown(
                            ...
                            selectedItem: subProvider.selectedSubscription,
                            isEnabled: true,
                            onChanged: (value) {
                              if (value != null) {
                          ...
                          AddSubscriptionDropdown(
                            ...
                            items:
                                subProvider.plans
                                    ...
                                    .toList(),
                            isEnabled: subProvider.selectedSubscription != null,
                            selectedItem: subProvider.selectedPlan?.toString(),
                            onChanged: (value) {
                              if (value != null) {
                          ...
                          IgnorePointer(
                            ignoring: subProvider.selectedSubscription == null,
                            ...
                            child: Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  BuildText(
                                    text:
                                        subProvider.selectedBillingCycle ?? "",
                                    textSize: 15,
                                  ),
                                  customSvg(
                                    path: "calendarSync",
